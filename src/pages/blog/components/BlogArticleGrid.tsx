      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          {category.articles.map((article, index) => (
            <div
              key={article.id}
              className={`group bg-white rounded-lg overflow-hidden border border-brand-navy/5 hover:border-brand-navy/15 hover:-translate-y-1 hover:shadow-sm transition-all duration-300 sr-fade-up sr-fast ${gridVisible ? "sr-visible" : ""}`}
